...
public class DiscountPrices extends javax.swing.JFrame {

    /**
     * Creates new form DiscountPrices
     */
    ...
    private void initComponents() {
        ...
        DiscountOutput.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        DiscountOutput.setForeground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(CalculatePrice, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(PurchasePrice)
                        .addComponent(DiscountAmount))
                    .addComponent(DiscountOutput, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(73, 73, 73))
    ...
    private void CalculatePriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculatePriceActionPerformed
        //10% off if the price is over $10
        //this must be solved using if/else statement
        double price = 0;
        double discount = 0;
        double total = 0;
        
        price = Double.parseDouble(PurchasePrice.getText());
        ...
        //DiscountOutput.setText(price));
        total = price;
        DiscountOutput.setText("$" + total);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiscountPrices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiscountPrices().setVisible(true);
            }
        });
    }
